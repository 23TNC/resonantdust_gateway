...
fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
            ...
            Reducer::ApplyAction{
                ...
                create_stacks: create_stacks.clone(),
                create_times: create_times.clone(),
                ...
                move_micros: move_micros.clone(),
                move_stacks: move_stacks.clone(),
                logops: logops.clone(),
}),
